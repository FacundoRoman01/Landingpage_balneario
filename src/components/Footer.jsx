    ...
    <footer className="footer">
      <div className="footer-container">
          ...
          <div className="footer-brand">
            <div className="footer-logo">
              <div className="footer-logo-icon">
                <Waves className="footer-logo-svg" />
              </div>
              <span className="footer-brand-name">BalnearioAI</span>
            </div>
            <p className="footer-brand-desc">
              Plataforma digital para automatizar la gestión de balnearios con IA, WhatsApp y dashboard inteligente.
            </p>
          </div>
        ...
        <div className="footer-bottom">
          <p>© {currentYear} BalnearioAI. Todos los derechos reservados.</p>
